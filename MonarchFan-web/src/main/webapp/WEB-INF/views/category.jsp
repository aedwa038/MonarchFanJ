...
<div class="container-fluid">
			<table class="table table-bordered">
				...
				<tbody>
               	    	<tr>	
               	    	<td class="col-md-1"> <span style="font-size:2.5em;" class="glyphicon glyphicon-align-right" aria-hidden="true"></span></td>
               	    	 <td class="col-md-8" >
				  			 	<h4><a href="<spring:url value="/topics/${topic.id}" />">${topic.topicName}</a></h4>
				  				<small>Topic by ${topic.user.userName}</small>
				 		</td>
				 		<td class="col-md-2"><p>Akeem</p></td>
				 		<td class="col-md-1"><p>25</p></td>
